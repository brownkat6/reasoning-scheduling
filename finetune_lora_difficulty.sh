#!/bin/bash
#SBATCH --job-name=lora__diff_train # Job name
...
#SBATCH --time=18:10:00 # Time limit
...
~/.conda/envs/torch/bin/python finetuning_difficulty.py  "--output_dir" "/n/netscratch/gershman_lab/Lab/amuppidi/reasoning" "--use_lora"